...
ETENDRE_FORCE = 0       # elargissement force a gauche : voir rendre_debuts.py
    ...
    for k, y in lignes:
        ...
        for tot,yy,rs in retenus:
            for a,b in rs:
                ...
                # commencait alors au milieu du mot, et generer.py jetait le
...
def extraire(chemin, garder_image=False):
    ...
    if len(idx):
        ...
        # rendre_debuts.py, qui recoupe en memoire et ne touche pas au corpus :
