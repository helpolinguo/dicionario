...
_DEBUTS=None
def debuts_rendus():
    """Premieres lettres rendues par rendre_debuts.py, par page."""
    global _DEBUTS
    if _DEBUTS is None:
...
_FILETS=None
def filets_neufs():
    """Filets recalcules par refaire_filets.py, par page."""
    global _FILETS
    if _FILETS is None:
...
def lignes_page(pg, lab, M, tab):
    ...
    # Filets recalcules : voir outils/refaire_filets.py. La detection d'origine
    ...
    # Debuts de ligne rendus (voir outils/rendre_debuts.py). Ils tombent AVANT
