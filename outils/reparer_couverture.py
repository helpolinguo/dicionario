...
Le choix des composantes s'est fait a l'oeil, sur planche (travail/cv_zone.png
et travail/cv_inv.png). On les designe ici par leur numero d'etiquette, mais on
...
def executer(sortie=f"{RAC}/travail/couv/B_repare.npy"):
