...
\l{}
\l{\cel{1}supozitorio. (medic.)\cel{3}Kono oblonga ek substanco medikamenta}
...
\l{\cel{4}zo qua esas an lu, interkontakte, en sama direciono vertikala :}
...
\l{\cel{4}solea. - L.}
\l{}
\l{\cel{1}surda. Di qua la oreli ne perceptas, o perceptas nur tre desfaci-}
...
\l{}
\l{\cel{1}surjeto. (sutado).Sut-uno ube la agulo trairas du stofo-peci po-}
...
\l{}
\l{\cel{1}surmuleto. (zool.) Maro-fisho. - L. Mullus surmuletus. - DEF.}
\l{}
\l{\cel{1}\sou{surogato}. To quo povas remplasar altra substanco (farmaciala,}
\l{\cel{4}tintala, e c.) pro havar ula karakterizivi analoga, ula efekti}
\l{\cel{4}analoga. - DEIR.}
\l{}
\l{\cel{1}\sou{surpliso}. (\sou{religio krist.}) Vesto ek telo plisuroza quan +weras,}
...
\l{\cel{4}psiko per ulo ne-expektita. - EFIS.}
}
