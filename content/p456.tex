...
\l{\cel{54}449}
\l{}
\l{\cel{1}\sou{podoido}. (\sou{matem.}) Singla de la kurvi quin onu obtenas per}
\l{\cel{4}prenar la simetrii di un punto Q, relate la tangenti di}
\l{\cel{4}ta kurvo.}
\l{}
\l{\cel{1}\sou{poemo}. Versaro pasable longa. - DEFIRS.}
\l{}
\l{\cel{1}poeto. Persono qua su konsakras a poezio ; persono qua esas}
...
\l{}
\l{\cel{1}\sou{poezio}. I. La arto facar verki ek versi. - II. Beleso di la ma-}
...
\l{\cel{4}maxima-force la atrakti e la repulsi magnetala, (b) Singla}
\l{\cel{4}ek la du extremaji inter-opozita di un fluo elektrala. -}
\l{\cel{4}DEFIRS.}
\l{}
\l{\sou{polarimetro}. (\sou{fiziko)}. Instrumento por mezurar la proporciono}
\l{\cel{4}di la lumo palarigita qua existas en lumo-radio o la rotaco di}
...
\l{\cel{4}manui e di la pedi. - EIL.}
\l{}
...
\l{\cel{4}reso statala, nacionala. - II. Surveyo quan onu agas por igar}
