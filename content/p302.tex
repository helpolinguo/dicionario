% page 303 of the facsimile (image p-302 of the scan)
...
\l{\cel{3}isti, e c.) +Seancar por la diskuto di temi ciencala, litera-}
\l{\cel{3}turala,politikala, e c. - II. (aludante ministri de nacioni}
\l{\cel{3}diversa, plenipotenciera). +Seancar por diskutar ula temi}
\l{\cel{3}internaciona. - DEFIRS.}
\l{}
\l{kongruar. (trans.) I. Qua fitas remarkinde-bone ta o ca cirkons-}
\l{\cel{3}tanco, ta o ca kazo. - II. (matem.) Nombri kongruanta : di qui}
\l{\cel{3}la interdifero esas multoplo di altra nombro (modulo). DEFIS.}
}
