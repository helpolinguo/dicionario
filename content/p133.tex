...
\l{\marge[78.737mm]{18.471mm}{\ornamento{11.765mm}{ornaments/letters/letter-E.png}}\cel{3}124}
\l{}
\l{}
\l{}
\l{}
\l{}
\l{}
\l{\cel{1}e. (muziko).Noto sepesma di la \textquotedbl{}do\textquotedbl{}-gamo.}
\l{}
\l{\cel{1}-e-.\cel{2}Infixo qua signifikas \textquotedbl{}samakolora kam\textquotedbl{} o \textquotedbl{}sam-aspekta}
...
\l{\cel{4}e remarkinda pro la beleso di lua obskur-nigreso. - DEFIS.}
\l{}
\l{\cel{1}-ebl-.\cel{2}Sufixo qua signifikas \textquotedbl{}quan onu povas...\textquotedbl{}.}
\l{}
\l{\cel{1}\sou{ebonito}. Kauchuko hardigita per vulkanizo, de qua onu facas}
\l{\cel{4}pektili, juveli, izolivi por la aparati elektrala.- DEFIRS.}
\l{}
...
\l{\cel{4}EFIS.}
\l{}
\l{\cel{1}ebuliar. (netrans.)Agitesar (aludante la surfaco di liqui-}
\l{\cel{4}do) kande lu bolieskas. - EFIS.}
\l{}
\l{\cel{1}ebulioskopo. Aparato per qua onu determinas, per bolio,}
...
\l{}
\l{ecentrika. I. (\sou{geom.}) Di qua la centro eskartesas de pn +n}
\l{\cel{4}donita. - II. Ecentriko : disko uzata por transformar}
