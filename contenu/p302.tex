...
\l{\cel{3}\sou{isti. e}\cel{1}c.) +Seancar por la diskuto di temi ciencala, liters-}
\l{\cel{3}turala,politikala, e c. - II. (\sou{aludante ministri de naoicni}}
\l{\cel{3}\sou{diversa, plenipotenciera}). +Seancar por diskutar ula temd}
\l{\cel{3}internaoiona, - DEFInS.}
\l{}
\l{,engruar. (trans.) l. Qua fitas remarkinde-bone ta o ca cirkons-}
\l{\cel{4}IIII. ta o al kazo. - II. (matem.) Nombri kongruanta : di qui}
\l{\cel{3}la interdifero esas multoplo dl altra nombro (modulo). DEFlS.}
}
