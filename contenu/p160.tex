...
\l{\cel{3}DEFIRS.}
\l{}
\l{e-o\cel{3}a.\cel{2}.\cel{3}\textquotedbl{}\cel{3}\sou{-  \textquotedbl{} \textquotedbl{}-}\cel{1}\textquotedbl{}\textquotedbl{}.\cel{2}\textquotedbl{}\cel{2}\textquotedbl{} \textquotedbl{}-\textquotedbl{}- - \textquotedbl{}\cel{5}-- --\cel{2}--\textquotedbl{}\textquotedbl{}}
\l{\cel{3}nia klimati. - II. (\sou{metaf.}) Qua ne apartenas a la lando ipsa,}
\l{\cel{3}nek a la landi relative vicina (pri la mori, la kustumi, e c.)}
\l{\cel{3}- DEFIS.}
}
