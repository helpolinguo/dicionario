...
%
% THE HEIGHT follows the rule the front already obeys, § Line heights,
% point 3: the two margins that remain above and below the mark are
% divided in golden section, the small one at the top -- 52.71 mm against
% 85.27, ratio 1/phi. That puts the centre of the disc at 0.4095 of the
% page height. It used to sit at 0.4703, the mirror of the front's emblem
% about the horizontal axis; with the larger disc that placing was
% compared side by side with this one, with 0.44, and with the geometric
% middle, and it is the golden one that reads as intended -- the mark
% holds the page instead of floating in it, and a sign on its own wants
% to sit above the middle, not on it.
%
% Both lengths are computed from the page, so the calculation can be
% redone: 1/phi^2 = 0.381966, and the top margin is 1/phi^2 of what the
% disc leaves.
\newlength{\versodiam}
\newlength{\posverso}
\newcommand{\platverso}{%
  ...
  \AddToShipoutPictureFG*{\AtPageUpperLeft{%
    ...
    \setlength{\posverso}{0.381966\dimexpr\paperheight-\versodiam\relax}%
