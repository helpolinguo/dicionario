...
// Chaque frappe remonte au sommet. La liste est CLASSEE — vedette exacte,
// vedette commencant par, vedette contenant, a une faute pres, a deux, puis
// definition — donc apres chaque frappe la reponse est en tete. Rester en
// place montrait le quarantieme resultat d'un ensemble qu'on n'a pas choisi :
// de « am » a « amp », la liste passe de 47 488 px a 9 657 et le premier
// resultat se retrouve 2 815 px au-dessus de l'ecran. Pire, quand la page
// raccourcit plus que la position ne le permet, le navigateur rogne
// lui-meme — de 44 449 px a 5 574 — et depose le lecteur au hasard.
//
// D'un coup, non en glissant : une glissade depuis 44 000 px durerait des
// secondes, defilerait devant des milliers d'articles, et la frappe suivante
// se battrait avec elle. Et seulement si l'on n'y est pas deja.
//
